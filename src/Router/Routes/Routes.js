...
import CourseCheckout from "../../Pages/Home/Courses/CourseCheckout";
import CourseInfo from "../../Pages/Home/Courses/CourseInfo";
import CoursePurchaseFailed from "../../Pages/Home/Courses/CoursePurchase/CoursePurchaseFailed";
import CoursePurchaseSuccess from "../../Pages/Home/Courses/CoursePurchase/CoursePurchaseSuccess";
import MoreCourses from "../../Pages/Home/Courses/MoreCourses";
import PurchaseHistory from "../../Pages/Home/Courses/PurchaseHistory";
...
import AllCourseList from "../../componenta/Dashboard/AllCourseList";
...
import AllPurchaseCourseList from "../../componenta/Dashboard/AllPurchaseCourseList";
import AllUsers from "../../componenta/Dashboard/AllUsers";
import CreateCourse from "../../componenta/Dashboard/CreateCourse";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/course-purchase/success/:id",
        element: (
          <PrivateRoute>
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://car-doctor-server-pied-zeta.vercel.app/api/v1/services/${params.id}`
          ),
      },
      {
        path: "/orders",
