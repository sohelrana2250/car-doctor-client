            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div className="mt-8 bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <div className="text-gray-600">
                        ...
                        <h1 className="text-xl font-serif">Course Purchase Failed </h1>
                    </div>
                    <div className="mt-6">
                        <Link to="/more-courses" className="btn btn-error w-full">Continue</Link>
...
export default CoursePurchaseFailed;